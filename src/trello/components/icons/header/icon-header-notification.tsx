...
type IconHeaderNotificationProps = {
  className?: string;
};

export const IconHeaderNotification: React.FC<IconHeaderNotificationProps> = ({
  className = 'w-5 h-5',
}) => {
  return (
    <svg
      className={`${className} text-gray-600 transition-colors hover:text-gray-800`}
      viewBox="0 0 16 16"
      fill="none"
