...
type IconTemplateCardProps = {
  className?: string;
};

const IconTemplateCard: FC<IconTemplateCardProps> = memo(function IconTemplateCard({
  className = 'h-4 w-4',
}) {
  return (
    <svg
      ...
      className={className}
      style={{ color: 'var(--ds-icon-accent-blue, #1D7AFC)' }}
    >
      <path
