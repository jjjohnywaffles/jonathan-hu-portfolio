...
type CardModalWidgetsProps = {
  isSidebarVisible: boolean;
  onToggleSidebar: () => void;
  bottomNavRef: React.RefObject<HTMLDivElement | null>;
};

const CardModalWidgets: FC<CardModalWidgetsProps> = memo(function CardModalWidgets({
  isSidebarVisible,
  onToggleSidebar,
  bottomNavRef,
}) {
    ...
    <div className="mt-4 flex flex-shrink-0 justify-center">
      <nav ref={bottomNavRef} className="rounded-lg border border-gray-200 bg-white p-2 shadow-md">
        <div className="flex items-center gap-1">
          ...
          {/* Comments and activity toggle button */}
          <button
